...
class DefaultApi {
  ...
  Future<Response<Object>> getLinkMetaLinkmetaGet({ 
    required String url,
...
_responseData = rawData == null ? null : deserialize<Object, Object>(rawData, 'Object', growable: true);
  ...
  /// Returns a [Future] containing a [Response] with a [Object] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<Object>> healthcheckHealthcheckGet({ 
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
    ValidateStatus? validateStatus,
...
_responseData = rawData == null ? null : deserialize<Object, Object>(rawData, 'Object', growable: true);
  ...
  /// Returns a [Future] containing a [Response] with a [Object] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<Object>> slackUserTokenSlackUserTokenPost({ 
    ...
    final _path = r'/slack_user_token';
    final _options = Options(
      method: r'POST',
      headers: <String, dynamic>{
        ...?headers,
