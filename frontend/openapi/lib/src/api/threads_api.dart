...
_responseData = rawData == null ? null : deserialize<UserMap, UserMap>(rawData, 'UserMap', growable: true);
  ...
  Future<Response<FullThreadInfo>> childThreadBlocksChildPost({ 
    ...
    try {
_bodyData=jsonEncode(createChildThreadModel);
    } catch(error, stackTrace) {
      throw DioException(
...
_responseData = rawData == null ? null : deserialize<FullThreadInfo, FullThreadInfo>(rawData, 'FullThreadInfo', growable: true);
  ...
  /// Throws [DioException] if API call or serialization fails
  Future<Response<bool>> deleteThreadThreadsIdDelete({ 
    required String id,
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
    ...
    final _path = r'/threads/{id}'.replaceAll('{' r'id' '}', id.toString());
    final _options = Options(
      method: r'DELETE',
      headers: <String, dynamic>{
        ...?headers,
...
_responseData = rawData == null ? null : deserialize<FullThreadInfo, FullThreadInfo>(rawData, 'FullThreadInfo', growable: true);
  ...
  /// * [onReceiveProgress] - A [ProgressCallback] that can be used to get the receive progress
  ///
  /// Returns a [Future] containing a [Response] with a [UserFilterPreferenceModel] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<UserFilterPreferenceModel>> getUserFilterPreferencesUserNewsFilterGet({ 
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
    ValidateStatus? validateStatus,
    ...
    final _path = r'/user/news-filter';
    final _options = Options(
      method: r'GET',
      headers: <String, dynamic>{
        ...?headers,
    ...
    UserFilterPreferenceModel? _responseData;

    try {
final rawData = _response.data;
_responseData = rawData == null ? null : deserialize<UserFilterPreferenceModel, UserFilterPreferenceModel>(rawData, 'UserFilterPreferenceModel', growable: true);
    } catch (error, stackTrace) {
      throw DioException(
        requestOptions: _response.requestOptions,
        response: _response,
    ...
    return Response<UserFilterPreferenceModel>(
      data: _responseData,
      headers: _response.headers,
      isRedirect: _response.isRedirect,
      requestOptions: _response.requestOptions,
  ...
  /// * [onReceiveProgress] - A [ProgressCallback] that can be used to get the receive progress
  ///
  /// Returns a [Future] containing a [Response] with a [ThreadsModel] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<ThreadsModel>> searchThreadsSearchThreadsGet({ 
    ...
    ThreadsModel? _responseData;

    try {
final rawData = _response.data;
_responseData = rawData == null ? null : deserialize<ThreadsModel, ThreadsModel>(rawData, 'ThreadsModel', growable: true);
    } catch (error, stackTrace) {
      throw DioException(
        requestOptions: _response.requestOptions,
        response: _response,
  ...
  /// Throws [DioException] if API call or serialization fails
  Future<Response<List<String>>> searchTitlesSearchTitlesGet({ 
    required String query,
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
...
_responseData = rawData == null ? null : deserialize<List<String>, String>(rawData, 'List<String>', growable: true);
  ...
  /// * [onReceiveProgress] - A [ProgressCallback] that can be used to get the receive progress
  ///
  /// Returns a [Future] containing a [Response] with a [ThreadsInfo] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<ThreadsInfo>> tiThreadsInfoGet({ 
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
    ValidateStatus? validateStatus,
    ...
    ThreadsInfo? _responseData;

    try {
final rawData = _response.data;
_responseData = rawData == null ? null : deserialize<ThreadsInfo, ThreadsInfo>(rawData, 'ThreadsInfo', growable: true);
    } catch (error, stackTrace) {
      throw DioException(
        requestOptions: _response.requestOptions,
        response: _response,
  ...
  /// Returns a [Future] containing a [Response] with a [List<String>] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<List<String>>> ttThreadTypesGet({ 
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
    ValidateStatus? validateStatus,
...
_responseData = rawData == null ? null : deserialize<List<String>, String>(rawData, 'List<String>', growable: true);
  ...
  /// Returns a [Future] containing a [Response] with a [BlockWithCreator] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<BlockWithCreator>> updateBlockAssignedUserBlocksIdAssignPut({ 
    required String id,
    ...
    final _path = r'/blocks/{id}/assign'.replaceAll('{' r'id' '}', id.toString());
    final _options = Options(
      method: r'PUT',
      headers: <String, dynamic>{
        ...?headers,
...
_responseData = rawData == null ? null : deserialize<BlockWithCreator, BlockWithCreator>(rawData, 'BlockWithCreator', growable: true);
  ...
  /// Returns a [Future] containing a [Response] with a [BlockWithCreator] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<BlockWithCreator>> updateBlockDueDateBlocksIdDueDatePut({ 
    required String id,
    required String body,
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    ...
    final _path = r'/blocks/{id}/dueDate'.replaceAll('{' r'id' '}', id.toString());
    final _options = Options(
      method: r'PUT',
      headers: <String, dynamic>{
        ...?headers,
...
_responseData = rawData == null ? null : deserialize<UpdateBlockPositionModel, UpdateBlockPositionModel>(rawData, 'UpdateBlockPositionModel', growable: true);
  ...
  /// Returns a [Future] containing a [Response] with a [BlockWithCreator] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<BlockWithCreator>> updateBlockTaskStatusBlocksIdTaskStatusPut({ 
    required String id,
    required String body,
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    ...
    final _path = r'/blocks/{id}/taskStatus'.replaceAll('{' r'id' '}', id.toString());
    final _options = Options(
      method: r'PUT',
      headers: <String, dynamic>{
        ...?headers,
